        ...
        this.emergencyContacts.forEach((contact, index) => {
            setTimeout(() => {
                ...
                console.log(`🚨 SMS Alert sent to ${contact.name} (${contact.phone}): 
                    "HEALTH ALERT: Abnormal vital signs detected for your family member. 
                    Heart Rate: ${Math.round(this.currentHeartRate)} BPM, 
                    Blood Oxygen: ${Math.round(this.currentBloodOxygen)}%. 
                    Location: Home. Time: ${new Date().toLocaleTimeString()}"`);
